...
#[Route('/admin', name: 'app_admin_blog_post_')]
final class AdminBlogPostController extends AbstractController
{
    #[Route(path: '/posts', name: 'manage')]
    ...
    #[Route(path: '/posts/create', name: 'create')]
    ...
    #[Route(path: '/posts/edit/{slug}', name: 'edit')]
